...
const soundPath = path.join(mainPath, './sextou');

const sextouseusidiotinhas = function (){
...
module.exports = sextouseusidiotinhas;

if (!module.parent) {
    sextouseusidiotinhas();
}